...
import { BadRequestError } from '@peter-lazarov/nodejs-reacjs-microservices-helper-library';
import { Request, Response } from 'express';
import { gigCreate } from '@gig/controllers/create';
import * as helper from '@peter-lazarov/nodejs-reacjs-microservices-helper-library';
...
jest.mock('@peter-lazarov/nodejs-reacjs-microservices-helper-library');
jest.mock('@peter-lazarov/nodejs-reacjs-microservices-helper-library');
