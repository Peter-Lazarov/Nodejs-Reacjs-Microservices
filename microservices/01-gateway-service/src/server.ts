...
import { CustomError, IErrorResponse, winstonLogger } from '@peter-lazarov/nodejs-reacjs-microservices-helper-library';
    ...
    app.use(
      cookieSession({
        ...
        ...(config.NODE_ENV !== 'development' && {
          //sameSite: 'none' //in production should be set
        })
      })
    );
    app.use(hpp());
