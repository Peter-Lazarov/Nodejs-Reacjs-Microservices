...
import { IAuthBuyerMessageDetails, IAuthDocument, firstLetterUppercase, lowerCase, winstonLogger } from '@peter-lazarov/nodejs-reacjs-microservices-helper-library';
